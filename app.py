...
from util.dataset_mixamo_additional import (
    BONES_IDX_DICT as BONES_IDX_DICT_ADD,
    load_kinematic_tree_additional,
)
...
def vis_blender(
    ...
    if db.is_mesh and db.anim_path.endswith(".fbx") and os.path.isfile(db.anim_path):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            fbx2glb_path = "models/make_it_animatable/data/FBX2glTF"
...
def init_models():
    global device, N, hands_resample_ratio, geo_resample_ratio, bw_additional, joints_additional, bones_idx_dict_bw, bones_idx_dict_joints, model_bw, model_bw_normal, model_joints, model_joints_add, model_coarse, model_pose, KINEMATIC_TREE, KINEMATIC_TREE_ADD

    KINEMATIC_TREE = load_kinematic_tree()
    KINEMATIC_TREE_ADD = load_kinematic_tree_additional()
    ...
    if ADDITIONAL_BONES:
        model_bw.load("models/make_it_animatable/data/bw.pth")
    else:
        model_bw.load("models/make_it_animatable/data/bw.pth")
    ...
    if ADDITIONAL_BONES:
        model_bw_normal.load("models/make_it_animatable/data/bw_normal.pth")
    else:
        model_bw_normal.load("models/make_it_animatable/data/bw_normal.pth")
    ...
    model_joints.load("models/make_it_animatable/data/joints.pth")
    ...
    if ADDITIONAL_BONES:
        ...
        model_joints_add.load("models/make_it_animatable/data/joints.pth")
    ...
    model_coarse.load("models/make_it_animatable/data/joints_coarse.pth")
    ...
    model_pose.load("models/make_it_animatable/data/pose.pth")
